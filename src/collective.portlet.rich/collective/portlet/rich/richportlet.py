...
class IRichPortlet(IPortletDataProvider):
    ...
    portlet_id = schema.TextLine(
        title=_(u"Portlet ID"),
        description=_(u"Assign a unique element id to this portlet"),
        required=False)

    portlet_classes = schema.TextLine(
        title=_(u"Portlet Classes"),
        description=_(u"Assign additional css classes to this portlet"),
        required=False)

    card = schema.Bool(
        title=_(u"Card"),
        description=_(u"Tick this box if this portlet should have the 'card' style"),
        required=False,
        default=False)
